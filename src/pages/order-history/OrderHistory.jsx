...
import { getLatestOrders } from '../../service/orderService';
            ...
            {orders.map(order => (
              ...
              <tr key={order.orderId}>
                ...
                <td>
                  ...
                  <span className={`badge ${order.paymentDetails?.status === "COMPLETED" ? "bg-success" : "bg-warning"}`}>{order.paymentDetails?.status || "PENDING"}</span>
                </td>
